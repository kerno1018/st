...
public class StockHistoryView implements Serializable {
    ...
    private AllStockCodeMapping stock;
    ...
    public AllStockCodeMapping getStock() {
        return stock;
    }

    public void setStock(AllStockCodeMapping stock) {
        this.stock = stock;
    }
